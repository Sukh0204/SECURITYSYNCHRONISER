const net = require("net"), fs = require("fs"), remote_server = process.argv[2]; // remote server ip address
let socket;

socket = remote_server ? net.connect(4999, remote_server) : net.connect(4999);

let ostream = fs.createWriteStream("./public/recieve/file");// change path
